...
df1 <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2005-2006/DR1IFF_D.xpt')
df2 <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2005-2006/DR2IFF_D.xpt')
dfc <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2005-2006/DRXFCD_D.xpt')
...
df_clinical <- read.csv('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.Data/_extracted/NHANES_2005_2006__2024-12-17.csv') %>%
  select(
...
write.csv(df_collapsed,
          paste0('C:/Users/rmcarri/OneDrive - Emory University/NHANES/Macronutrients LLMs/02.Datasets/df_20052006_', Sys.Date(), '.csv'),
          row.names = FALSE)
