...
df = pd.read_csv('/scratch/rmcarri/Macronutrients_LLMs/Combined_df_ten_shot_day2_chunk7.csv')
...
df.to_csv(f'/scratch/rmcarri/Macronutrients_LLMs/Combined_df_ten_shot_day2_chunk7_{model_name}.csv', index = False)
print("END")