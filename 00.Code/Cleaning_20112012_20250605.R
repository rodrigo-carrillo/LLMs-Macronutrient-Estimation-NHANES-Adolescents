...
df1 <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2011-2012/DR1IFF_G.xpt')
df2 <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2011-2012/DR2IFF_G.xpt')
dfc <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2011-2012/DRXFCD_G.xpt')
...
df_clinical <- read.csv('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.Data/_extracted/NHANES_2011_2012__2024-12-17.csv') %>%
  select(
...
write.csv(df_collapsed,
          paste0('C:/Users/rmcarri/OneDrive - Emory University/NHANES/Macronutrients LLMs/02.Datasets/df_20112012_', Sys.Date(), '.csv'),
          row.names = FALSE)
