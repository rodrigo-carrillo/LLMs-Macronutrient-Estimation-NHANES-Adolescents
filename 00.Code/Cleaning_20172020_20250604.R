...
df1 <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2017-March 2020/P_DR1IFF.xpt')
df2 <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2017-March 2020/P_DR2IFF.xpt')
dfc <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2017-March 2020/P_DRXFCD.xpt')
...
df_clinical <- read.csv('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.Data/_extracted/NHANES_2017_March 2022__2024-12-17.csv') %>%
  select(
...
write.csv(df_collapsed,
          paste0('C:/Users/rmcarri/OneDrive - Emory University/NHANES/Macronutrients LLMs/02.Datasets/df_20172020_', Sys.Date(), '.csv'),
          row.names = FALSE)
