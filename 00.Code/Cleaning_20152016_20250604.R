...
df1 <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2015-2016/DR1IFF_I.xpt')
df2 <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2015-2016/DR2IFF_I.xpt')
dfc <- read_xpt('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.dietaryindex/NHANES 2015-2016/DRXFCD_I.xpt')
...
df_clinical <- read.csv('C:/Users/rmcarri/OneDrive - Emory University/NHANES/00.Data/_extracted/NHANES_2015_2016__2024-12-17.csv') %>%
  select(
...
write.csv(df_collapsed,
          paste0('C:/Users/rmcarri/OneDrive - Emory University/NHANES/Macronutrients LLMs/02.Datasets/df_20152016_', Sys.Date(), '.csv'),
          row.names = FALSE)
